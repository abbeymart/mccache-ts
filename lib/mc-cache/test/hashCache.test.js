    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mc_test_1.mcTest({
                    ...
                    testFunc: function () {
                        var cacheRes = src_1.setHashCache(cacheKey, hashKey, cacheValue, expiryTime);
                        if (cacheRes.ok) {
                            ...
                            // get cache info
                            var res = src_1.getHashCache(cacheKey, hashKey);
            ...
            case 1:
                ...
                return [4 /*yield*/, mc_test_1.mcTest({
                        ...
                        testFunc: function () {
                            var cacheRes = src_1.clearHashCache();
                            if (cacheRes.ok) {
                                mc_test_1.assertEquals(cacheRes.ok, true);
                                mc_test_1.assertEquals(cacheRes.message, 'task completed successfully');
                                // get cache info
            ...
            case 2:
                ...
                return [4 /*yield*/, mc_test_1.mcTest({
                        ...
                        testFunc: function () {
                            ...
                            var cacheRes = src_1.setHashCache(cacheKey, hashKey, cacheValue, 2);
                            if (cacheRes.ok) {
                                mc_test_1.assertEquals(cacheRes.ok, true);
                                mc_test_1.assertEquals(cacheRes.value, cacheValue);
                                mc_test_1.assertEquals(cacheRes.message, 'task completed successfully');
                        ...
                        testFunc: function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        res = src_1.getHashCache(cacheKey, hashKey);
                                        mc_test_1.assertEquals(res.ok, false);
            ...
            case 4:
                ...
                return [4 /*yield*/, mc_test_1.mcTest({
                        ...
                        testFunc: function () {
                            ...
                            var cacheRes = src_1.setHashCache(cacheKey, hashKey, cacheValue, 10);
                            if (cacheRes.ok) {
                                mc_test_1.assertEquals(cacheRes.ok, true);
                                mc_test_1.assertEquals(cacheRes.value, cacheValue);
                                mc_test_1.assertEquals(cacheRes.message, 'task completed successfully');
            ...
            case 5:
                ...
                return [4 /*yield*/, mc_test_1.mcTest({
                        ...
                        testFunc: function () {
                            var cacheRes = src_1.deleteHashCache(cacheKey, hashKey);
                            if (cacheRes.ok) {
                                mc_test_1.assertEquals(cacheRes.ok, true);
                                mc_test_1.assertEquals(cacheRes.message, 'task completed successfully');
                                var res = src_1.getHashCache(cacheKey, hashKey);
